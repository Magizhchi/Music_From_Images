package spikeFiles; /******************************************************************************
 *  Compilation:  javac spikeFiles.StdDraw.java
 *  Execution:    java spikeFiles.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code spikeFiles.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have <tt>spikeFiles.StdDraw.class</tt> in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "http://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">spikeFiles.StdDraw.java</a>
 ...
 *           spikeFiles.StdDraw.setPenRadius(0.05);
 *           spikeFiles.StdDraw.setPenColor(spikeFiles.StdDraw.BLUE);
 *           spikeFiles.StdDraw.point(0.5, 0.5);
 *           spikeFiles.StdDraw.setPenColor(spikeFiles.StdDraw.MAGENTA);
 *           spikeFiles.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code spikeFiles.StdDraw.line()} and {@code spikeFiles.StdDraw.point()}
 *  draw lines and points; the methods {@code spikeFiles.StdDraw.setPenRadius()}
 *  and {@code spikeFiles.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code spikeFiles.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   spikeFiles.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code spikeFiles.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code spikeFiles.StdDraw.setPenColor(spikeFiles.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code spikeFiles.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code spikeFiles.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   spikeFiles.StdDraw.setFont(font);
 *   spikeFiles.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code spikeFiles.StdDraw.clear(spikeFiles.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 ...
 *  results appear on the screen. {@code spikeFiles.StdDraw.show()} turns off
 *  animation mode.
 *  <p>
 ...
 *       number of objects.
 *       That is, call {@code spikeFiles.StdDraw.show(0)} before
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * <tt>spikeFiles.StdDraw.BLACK</tt>, <tt>spikeFiles.StdDraw.BLUE</tt>, <tt>spikeFiles.StdDraw.CYAN</tt>,
     * <tt>spikeFiles.StdDraw.DARK_GRAY</tt>, <tt>spikeFiles.StdDraw.GRAY</tt>, <tt>spikeFiles.StdDraw.GREEN</tt>,
     * <tt>spikeFiles.StdDraw.LIGHT_GRAY</tt>, <tt>spikeFiles.StdDraw.MAGENTA</tt>, <tt>spikeFiles.StdDraw.ORANGE</tt>,
     * <tt>spikeFiles.StdDraw.PINK</tt>, <tt>spikeFiles.StdDraw.RED</tt>, <tt>spikeFiles.StdDraw.WHITE</tt>, and
     * <tt>spikeFiles.StdDraw.YELLOW</tt>.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to spikeFiles.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
